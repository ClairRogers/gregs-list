...
let _state = {
  houses: [
    ...
    new House({ title: 'You must be rich', price: 200000000, description: 'This some hardcore Downton Abbey nonsense', img: 'https://pmcvariety.files.wordpress.com/2017/03/kellyclarkson_tn_fi.jpg?w=670' }),
    new House({ title: 'This is not a house', price: 8000, description: 'It is a boat. but, a very cool boat', img: 'https://cdn0.wideopencountry.com/wp-content/uploads/2017/11/Tiny-Houseboat-F1-793x526.jpg' })
  ]
}
